...
module {
  func.func @main_graph(%arg0: tensor<1x3x224x224xf32>) -> tensor<1x1000xf32> {
    ...
    ^bb0(%in: f32, %out: f32):
      %143 = arith.cmpf ugt, %in, %cst_0 : f32
      %144 = arith.select %143, %in, %cst_0 : f32
    ...
    %14 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%12, %13 : tensor<1x256x56x56xf32>, tensor<1x256x56x56xf32>) outs(%11 : tensor<1x256x56x56xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
    ...
    %21 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%20, %15 : tensor<1x256x56x56xf32>, tensor<1x256x56x56xf32>) outs(%11 : tensor<1x256x56x56xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x256x56x56xf32>
    ...
    %28 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%27, %22 : tensor<1x256x56x56xf32>, tensor<1x256x56x56xf32>) outs(%11 : tensor<1x256x56x56xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x256x56x56xf32>
    ...
    %39 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%37, %38 : tensor<1x512x28x28xf32>, tensor<1x512x28x28xf32>) outs(%36 : tensor<1x512x28x28xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    ...
    %46 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%45, %40 : tensor<1x512x28x28xf32>, tensor<1x512x28x28xf32>) outs(%36 : tensor<1x512x28x28xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x512x28x28xf32>
    ...
    %53 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%52, %47 : tensor<1x512x28x28xf32>, tensor<1x512x28x28xf32>) outs(%36 : tensor<1x512x28x28xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x512x28x28xf32>
    ...
    %60 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%59, %54 : tensor<1x512x28x28xf32>, tensor<1x512x28x28xf32>) outs(%36 : tensor<1x512x28x28xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x512x28x28xf32>
    ...
    %71 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%69, %70 : tensor<1x1024x14x14xf32>, tensor<1x1024x14x14xf32>) outs(%68 : tensor<1x1024x14x14xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    ...
    %78 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%77, %72 : tensor<1x1024x14x14xf32>, tensor<1x1024x14x14xf32>) outs(%68 : tensor<1x1024x14x14xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x1024x14x14xf32>
    ...
    %85 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%84, %79 : tensor<1x1024x14x14xf32>, tensor<1x1024x14x14xf32>) outs(%68 : tensor<1x1024x14x14xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x1024x14x14xf32>
    ...
    %92 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%91, %86 : tensor<1x1024x14x14xf32>, tensor<1x1024x14x14xf32>) outs(%68 : tensor<1x1024x14x14xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x1024x14x14xf32>
    ...
    %99 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%98, %93 : tensor<1x1024x14x14xf32>, tensor<1x1024x14x14xf32>) outs(%68 : tensor<1x1024x14x14xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x1024x14x14xf32>
    ...
    %106 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%105, %100 : tensor<1x1024x14x14xf32>, tensor<1x1024x14x14xf32>) outs(%68 : tensor<1x1024x14x14xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x1024x14x14xf32>
    ...
    %117 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%115, %116 : tensor<1x2048x7x7xf32>, tensor<1x2048x7x7xf32>) outs(%114 : tensor<1x2048x7x7xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    ...
    %124 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%123, %118 : tensor<1x2048x7x7xf32>, tensor<1x2048x7x7xf32>) outs(%114 : tensor<1x2048x7x7xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x2048x7x7xf32>
    ...
    %131 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%130, %125 : tensor<1x2048x7x7xf32>, tensor<1x2048x7x7xf32>) outs(%114 : tensor<1x2048x7x7xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x2048x7x7xf32>
    ...
    %142 = linalg.generic {indexing_maps = [#map1, #map2, #map1], iterator_types = ["parallel", "parallel"]} ins(%141, %cst_108 : tensor<1x1000xf32>, tensor<1000xf32>) outs(%139 : tensor<1x1000xf32>) {
    ^bb0(%in: f32, %in_179: f32, %out: f32):
      %143 = arith.addf %in, %in_179 : f32
      linalg.yield %143 : f32
    } -> tensor<1x1000xf32>
